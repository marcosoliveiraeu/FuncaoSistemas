...
namespace FI.AtividadeEntrevista.BLL
{
    public class BoCliente
    {
        ...
        public DML.Beneficiario ConsultarBeneficiarioPorId(long id)
        {
            DAL.DaoBeneficiario beneficiario = new DAL.DaoBeneficiario();
            return beneficiario.ConsultarPorId(id);
        }

        public List<DML.Beneficiario> ConsultarBeneficiarioPorCliente(string cpf)
        {
            DAL.DaoBeneficiario beneficiario = new DAL.DaoBeneficiario();
            return beneficiario.ConsultarPorCliente(cpf);
        }
